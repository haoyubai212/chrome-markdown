...
const messages = {
  zh: {
    ...
    noHeadings: '当前文档没有标题。', switchFolder: '切换文件夹', loadContainingFolder: '加载所在文件夹', restoreFolderShort: '恢复“{name}”',
    switchTheme: '切换主题', refresh: '重新读取', readingSettings: '阅读设置', close: '关闭', copyFileAddress: '复制完整文件地址', fileAddressCopied: '文件地址已复制',
    theme: '主题', lightTheme: '浅色', darkTheme: '深色',
    ...
    restoreFolder: '恢复“{name}”文件夹访问权限', restoreFolderPersistent: '已记住“{name}”。恢复时建议选择“每次访问都允许”', fileNotFound: '找不到 {path}',
    ...
    selectContainingFolder: '请选择包含“{name}”的文件夹或其上级目录。', savedFolderMismatch: '已保存的文件夹中找不到当前文件，请重新选择所在文件夹。', permissionNotGranted: '未获得文件夹访问权限。',
  },
  en: {
    ...
    noHeadings: 'This document has no headings.', switchFolder: 'Change folder', loadContainingFolder: 'Load containing folder', restoreFolderShort: 'Restore “{name}”',
    switchTheme: 'Toggle theme', refresh: 'Refresh', readingSettings: 'Reading settings', close: 'Close', copyFileAddress: 'Copy full file address', fileAddressCopied: 'File address copied',
    ...
    restoreFolder: 'Restore access to “{name}”', restoreFolderPersistent: '“{name}” is remembered. Choose “Allow on every visit” when prompted', fileNotFound: 'Could not find {path}',
    ...
    selectContainingFolder: 'Choose the folder containing “{name}” or one of its parent folders.', savedFolderMismatch: 'The current file was not found in a saved folder. Choose its containing folder again.', permissionNotGranted: 'Folder access was not granted.',
  },
} as const
